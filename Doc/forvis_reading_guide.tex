...
The execution spec is modularized in the same way as the ISA itself:
...
\section{Preliminaries for Instruction Specs}
...
\subsection{Execution semantics for each I instruction}
...
\section{File {\tt Forvis\_Spec.hs}: the ISA spec}
